...
<br>
<a href="ng3ec6f.php">[&lt;&lt;Previous Entry]</a> <a href="ng361d7.php">[^^Up^^]</a> <a href="ng3f079.php">[Next Entry&gt;&gt;]</a> <a href="index.php">[Menu]</a> <a href="credits.php">[About The Guide]</a>
<hr><pre>

struc RemoveMediaRequest        ; Device-Driver function 0Fh
 rmrLength      db ?            ; Length of structure, in bytes
 rmrUnit        db ?            ; Unit number
 rmrFunction    db ?            ; Function number (0Fh)
 rmrStatus      dw ?            ; Status
 rmrReserved    db 8 dup (?)    ; Reserved
ends                            ; = 13d bytes
</pre><hr><b>See Also:</b> <a href="ng33cf3.php">Dev0Fh</a> <pre></pre><hr><center><b>
