...
<br>
<a href="ng373d7.php">[&lt;&lt;Previous Entry]</a> <a href="ng361d7.php">[^^Up^^]</a> <a href="ng37776.php">[Next Entry&gt;&gt;]</a> <a href="index.php">[Menu]</a> <a href="credits.php">[About The Guide]</a>
<hr><pre>

struc CPList
 cplLength      dw ((hardware_ids+1) * (prepared_ids+1)) * 2
                                        ; Byte size of structure,
                                        ;   excluding this field
 cplHIds        dw hardware_ids         ; No. of hardware code pages
 cplHId         dw hardware_ids dup (?) ; Array of hardware code pages
 cplPIds        dw prepared_ids         ; No. of prepared code pages
 cplPId         dw prepared_ids dup (?) ; Array of prepared code pages
ends
</pre><hr><b>See Also:</b> <a href="ngff76.php">440Ch /6bh</a> <pre></pre><hr><center><b>
